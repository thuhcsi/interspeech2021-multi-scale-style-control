...
To demonstrate the influence of global-scale style embedding (**GSE**) and local-scale prosody embedding (**LPE**) in our proposed multi-scale speech style modeling method, the parallel style transfer results of **Base-G**, **Base-L**, and proposed model is provided here for comparison.

| Reference Audio | Emotion | Text | Synthesized (**Base-L**) | Synthesized (**Base-G**) | Synthesized (**Proposed**) |
| :---- | :---- | :---- | :---- | :---- | :---- |
